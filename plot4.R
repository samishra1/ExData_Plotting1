...
## Create Plot 4. Start with plotting Sub_metering_1 against Dttm
...
##Plot Global Active Power vs Dttm

with(pwr3, plot(Dttm, as.numeric(Global_active_power)/1000, type = "l", xlab = "Datetime", ylab = "Global Active Power"))

##Plot Voltage Vs Dttm

with(pwr3, plot(Dttm, as.numeric(Voltage)/1000, type = "l", xlab = "Datetime", ylab = "Voltage"))

##Plot Energy Sub Metering Vs Dtm
...
legend("topright", lty=c(1,1), cex = 0.5, col = c("gray", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))


##Plot Global Reactive Power Vs Dttm
with(pwr3, plot(Dttm, as.numeric(Global_reactive_power)/1000, type = "l", xlab = "Datetime", ylab = "Global Reactive Power"))
